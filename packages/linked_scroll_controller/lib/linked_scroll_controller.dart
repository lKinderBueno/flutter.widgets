...
class LinkedScrollControllerGroup {
  ...
  final allControllers = <_LinkedScrollController>[];
  ...
  Iterable<_LinkedScrollController> get _attachedControllers => allControllers.where((controller) => controller.hasClients);
...
class _LinkedScrollController extends ScrollController {
  ...
  _LinkedScrollController(this._controllers, {required double initialScrollOffset})
      : super(initialScrollOffset: initialScrollOffset, keepScrollOffset: false);

  @override
  void dispose() {
    _controllers.allControllers.remove(this);
    super.dispose();
  }
